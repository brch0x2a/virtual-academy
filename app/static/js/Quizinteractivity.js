...
var quiz = {
	...
	allQuestions: [
		...
		{"question":"Capital de CR?",
		"choices":["Heredia","Alajuela","Sanjose","Cartago"],
		"correctAnswer":3},
	
		{"question":"independencia de costa rica?",
		"choices":["1492","1776","1821","1791"],
		"correctAnswer":3}
	...
	welcome: function(name) {
		...
		var greetingText = document.createTextNode('Quiz ' + name + '!');
	...
	showQuestion: function(bookmark) {
		...
		print(quiz.allQuestions[quiz.index]["question"]);
		...
		for (var i = 0; i < quiz.allQuestions[quiz.index]["choices"].length; i++) {
			...
			console.log(quiz.allQuestions[quiz.index]['choices'][i]);
		}
